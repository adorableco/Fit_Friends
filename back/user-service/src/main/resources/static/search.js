...
api[0].list[0].list.push({
    ...
    deprecated: 'false',
    url: '/login/{code}',
    methodId: '80f30d622738ab52efc7c4c634c4842e',
    desc: '소셜 로그인 후 사용자 정보를 요청하여 처리합니다.',
});
api[0].list.push({
...
api[0].list[1].list.push({
    ...
    deprecated: 'false',
    url: '/signup',
    methodId: 'bd710c0a529e16bc1254d1bddae5ea03',
    desc: '사용자 회원가입 처리',
});
api[0].list[1].list.push({
    order: '2',
    deprecated: 'false',
    url: '/users/{userId}',
    methodId: 'dc832a2d4e91ac752b5fc1846b59c982',
    desc: '특정 사용자의 상세 정보 조회',
});
api[0].list[1].list.push({
    order: '3',
    deprecated: 'false',
    url: '/users/game-results',
    methodId: 'a5457489b4b6b61f600b6430af6288c8',
    desc: '게임 결과를 적용하여 사용자 정보 업데이트',
});
api[0].list[1].list.push({
    order: '4',
    deprecated: 'false',
    url: '/users',
    methodId: '4f5a5768449ae7dd78947dfd8aa90a1d',
    desc: '사용자 상세 정보 수정',
});
